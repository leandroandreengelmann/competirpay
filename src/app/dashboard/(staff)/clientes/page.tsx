    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col gap-1 border-b border-gray-100 pb-4">
                <h1 className="text-2xl font-black tracking-tight text-gray-900">Clientes</h1>
                <p className="text-sm text-muted-foreground">
                    Clientes registrados no COMPETIR PAY.
                </p>
            </div>
                    ...
                    <TableBody>
                        ...
                        {profiles?.map((profile, idx) => (
                            <TableRow key={profile.id} className="hover:bg-gray-50/50">
                                ...
                                <TableCell>
                                    <Badge variant="outline" className="text-[10px] uppercase font-bold tracking-wider bg-emerald-100 text-emerald-700 border-emerald-200">
                                        Cliente
                                    </Badge>
                                </TableCell>
                                ...
                                <TableCell>
                                    <Button variant="ghost" size="icon" className="h-8 w-8 text-zinc-400 hover:text-zinc-600" asChild>
                                        <Link href={`/dashboard/clientes/${profile.id}/editar`}>
                                            <Edit2 size={16} />
                                        </Link>
                                    </Button>
                                </TableCell>
